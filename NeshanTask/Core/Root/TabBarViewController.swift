...
private extension TabBarViewController {
    ...
    private func setupTabs() {
        ...
        let contactView = self.createNav(with: "Contact", image: UIImage(systemName: "person.crop.circle"), vc: ContactViewController())
        let tripsView = self.createNav(with: "Trips", image: UIImage(systemName: "bookmark"), vc: TripsViewController())
        self.setViewControllers([exploreView,contactView,tripsView], animated: true)
    }
